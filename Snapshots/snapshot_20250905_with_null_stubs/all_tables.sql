  ...
  CREATE TABLE "TR2000_STAGING"."CONTROL_ENDPOINTS"
   (	"ENDPOINT_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9
999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCL
E  NOKEEP  NOSCALE  NOT NULL ENABLE,
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "CHK_ENDPOINT_KEY_UPPERCASE" CHECK (endpoint_key = UPPER(endpoint_k
ey)) ENABLE
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "TR2000_STAGING"."ETL_ERROR_LOG"
   (	"ERROR_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999
...
NOKEEP	NOSCALE  NOT NULL ENABLE,
 ...
 LOB ("RAW_DATA") STORE AS SECUREFILE (
  ...
  CREATE TABLE "TR2000_STAGING"."ETL_FILTER"
   (	"FILTER_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 999
9999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER	NOCYCLE
 NOKEEP  NOSCALE  NOT NULL ENABLE,
	"PLANT_ID" VARCHAR2(50) NOT NULL ENABLE,
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "TR2000_STAGING"."ETL_RUN_LOG"
   (	"RUN_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 999999
9999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NO
KEEP  NOSCALE  NOT NULL ENABLE,
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "TR2000_STAGING"."ETL_STATISTICS"
   (	"STAT_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 99999
...
OKEEP  NOSCALE	NOT NULL ENABLE,
	...
	"END_TIME" TIMESTAMP (6),
	"DURATION_MS" NUMBER GENERATED ALWAYS AS (CASE	WHEN "END_TIME" IS NOT NULL THE
N EXTRACT(DAY FROM ("END_TIME"-"START_TIME")DAY(9) TO SECOND(6))*86400000+EXTRAC
T(HOUR FROM ("END_TIME"-"START_TIME")DAY(9) TO SECOND(6))*3600000+EXTRACT(MINUTE
 FROM ("END_TIME"-"START_TIME")DAY(9) TO SECOND(6))*60000+EXTRACT(SECOND FROM ("
END_TIME"-"START_TIME")DAY(9) TO SECOND(6))*1000 ELSE NULL END) VIRTUAL ,
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "UK_PCS_EMBEDDED_NOTES" UNIQUE ("PLANT_ID", "PCS_NAME", "PCS_REVISI
ON", "TEXT_SECTION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
 ...
 LOB ("NOTEPAD") STORE AS SECUREFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "UK_PCS_PIPE_ELEMENTS" UNIQUE ("PLANT_ID", "PCS_NAME", "PCS_REVISIO
N", "ELEMENT_GROUP_NO", "LINE_NO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "UK_PCS_PIPE_SIZES" UNIQUE ("PLANT_ID", "PCS_NAME", "PCS_REVISION",
 "NOM_SIZE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "UK_PCS_TEMP_PRESSURES" UNIQUE ("PLANT_ID", "PCS_NAME", "PCS_REVISI
ON", "TEMPERATURE", "PRESSURE")
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "UK_PCS_VALVE_ELEMENTS" UNIQUE ("PLANT_ID", "PCS_NAME", "PCS_REVISI
ON", "VALVE_GROUP_NO", "LINE_NO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE TABLE "TR2000_STAGING"."PIPE_ELEMENT_REFERENCES"
   (	"PIPE_ELEMENT_REFERENCES_GUID" RAW(16) DEFAULT SYS_GUID() NOT NULL ENABLE,
	...
	"LAST_MODIFIED_DATE" DATE DEFAULT SYSDATE NOT NULL ENABLE,
	 CONSTRAINT "PK_PIPE_ELEMENT_REFERENCES" PRIMARY KEY ("PIPE_ELEMENT_REFERENCES_
GUID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "UK_PIPE_ELEMENT_REF" UNIQUE ("PLANT_ID", "ISSUE_REVISION", "ELEMEN
T_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "TR2000_STAGING"."RAW_JSON"
   (	"RAW_JSON_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9
999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCL
E  NOKEEP  NOSCALE  NOT NULL ENABLE,
	"ENDPOINT_KEY" VARCHAR2(100),
	"ENDPOINT_TEMPLATE" VARCHAR2(500),
